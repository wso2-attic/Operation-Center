 ...
 */
package org.wso2.carbon.oc.pubsub.messaging.util;
...
//import org.wso2.carbon.oc.pubsub.messaging.message.JsonMessage;
...
public class MessagingUtil {
    ...
    private static final Log log = LogFactory.getLog(org.wso2.carbon.oc.pubsub.messaging.util.MessagingUtil.class);
    ...
    private static final String ORG_APACHE_STRATOS_MESSAGING_EVENT_PACKAGE = "org.wso2.carbon.oc.pubsub.messaging.event.";
    ...
    public static int getSubscriberFailoverInterval() {
        if (failoverPingInterval <= 0) {
            failoverPingInterval =
                    org.wso2.carbon.oc.pubsub.messaging.util.MessagingUtil
		                    .getNumericSystemProperty(DEFAULT_FAILOVER_PING_INTERVAL,
