...
package org.wso2.carbon.oc.pubsub.messaging.broker.publish;
...
public class EventPublisherPool {
    private static final Log log = LogFactory.getLog(
		    org.wso2.carbon.oc.pubsub.messaging.broker.publish.EventPublisherPool.class);
    private static Map<String, org.wso2.carbon.oc.pubsub.messaging.broker.publish.EventPublisher>
		    topicNameEventPublisherMap = new HashMap<String, org.wso2.carbon.oc.pubsub.messaging.broker.publish.EventPublisher>();

    public static org.wso2.carbon.oc.pubsub.messaging.broker.publish.EventPublisher getPublisher(String topicName) {
        synchronized (org.wso2.carbon.oc.pubsub.messaging.broker.publish.EventPublisherPool.class) {
            ...
            org.wso2.carbon.oc.pubsub.messaging.broker.publish.EventPublisher
