...
import org.wso2.carbon.oc.agent.messaging.broker.connect.TopicConnector;
...
public abstract class AmqpTopicConnector implements TopicConnector {
    ...
    private static final Log log = LogFactory.getLog(
		    org.wso2.carbon.oc.agent.messaging.broker.connect.amqp.AmqpTopicConnector.class);
    ...
    public void create() {
        try {
	        //TODO
	        System.setProperty("jndi.properties.dir", CarbonUtils.getCarbonConfigDirPath());
     ...
     * @throws javax.jms.JMSException if unable to create a topic session
     */
