...
package org.wso2.carbon.oc.agent.messaging.broker.subscribe;
...
public class EventSubscriber implements Runnable {
    ...
    private static final Log log = LogFactory.getLog(
		    org.wso2.carbon.oc.agent.messaging.broker.subscribe.EventSubscriber.class);
    private final org.wso2.carbon.oc.agent.messaging.broker.connect.TopicSubscriber topicSubscriber;
