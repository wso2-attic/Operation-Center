...
public class EventPublisher {
    ...
    private static final Log log = LogFactory.getLog(
		    org.wso2.carbon.oc.agent.messaging.broker.publish.EventPublisher.class);
    ...
    public void publish(Object messageObj, boolean retry) {
        synchronized (org.wso2.carbon.oc.agent.messaging.broker.publish.EventPublisher.class) {
            Gson gson = new Gson();
