...
package org.wso2.carbon.oc.agent.messaging.broker.connect.amqp;

import org.apache.activemq.command.ActiveMQMessage;
import org.wso2.carbon.oc.agent.messaging.broker.connect.RetryTimer;
import org.wso2.carbon.oc.agent.messaging.broker.connect.TopicSubscriber;
import org.wso2.carbon.oc.agent.messaging.broker.connect.amqp.AmqpTopicConnector;
import org.wso2.carbon.oc.agent.messaging.broker.subscribe.MessageListener;
import org.wso2.carbon.oc.agent.messaging.domain.exception.MessagingException;
...
public class AmqpTopicSubscriber extends AmqpTopicConnector implements TopicSubscriber {
    ...
    protected static final Log log = LogFactory.getLog(
		    org.wso2.carbon.oc.agent.messaging.broker.connect.amqp.AmqpTopicSubscriber.class);
            ...
            topicSubscriber.setMessageListener(new javax.jms.MessageListener() {
                ...
                public void onMessage(Message message) {
	                try {
		                ...
		                }org.wso2.carbon.oc.agent.messaging.domain.Message message_ =
				                new org.wso2.carbon.oc.agent.messaging.domain.Message(topicName, messageText);
